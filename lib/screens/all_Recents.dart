...
class _AllRecentsState extends State<AllRecents> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AllRencentsScreen(widget.snapshotGenre),
    );
  }
}

class AllRencentsScreen extends StatefulWidget {
  final AsyncSnapshot<GenreModel> snapshotGenre;
  AllRencentsScreen(this.snapshotGenre);
  @override
  _AllRencentsScreenState createState() => _AllRencentsScreenState();
}

class _AllRencentsScreenState extends State<AllRencentsScreen> {
  BannerAd _bannerAd;
